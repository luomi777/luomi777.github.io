  ...
  <body>
    <div class="wrapper">
      ...
      <section>
          ...
          <ul>
      <li><papertitle>When Thinking Drifts: Evidential Grounding for Robust Video Reasoning</papertitle>
        <br>
        <strong>Mi Luo</strong>, Zihui Xue, Alex Dimakis, Kristen Grauman
        <br>
        [PDF coming soon][<a href="https://vision.cs.utexas.edu/projects/video-ver" target="_blank" rel="noopener">Project</a>]          
        ...
        <ul>
              ...
              <li><papertitle>Put Myself in Your Shoes: Lifting the Egocentric Perspective from Exocentric Videos</papertitle>
                ...
                In 2024 European Conference on Computer Vision, <strong>ECCV 2024</strong>.
                <br>
                [<a href="https://arxiv.org/pdf/2403.06351.pdf" target="_blank" rel="noopener">PDF</a>][<a href="https://vision.cs.utexas.edu/projects/Exo2Ego/" target="_blank" rel="noopener">Project</a>]
                </ul>
        ...
        <h1 id="research"><a href="#research" class="headerlink" title="research"></a>Research Experiences</h1>
             ...
             <ul>
              <li><p style="float:right">Mountain View, May 2025 - Present</p> <strong>Google</strong>
                <br>
                Student Researcher, Topics: video generation/perception</a>
              </ul>
            <ul>
